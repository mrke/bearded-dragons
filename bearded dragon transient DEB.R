...
daystart<-'90/11/12' # y/m/d
dayfin<-'90/11/12' # y/m/d
...
dayresults<-data.frame(matrix(vector(), interval*(days+1), 9, dimnames=list(c(), c("Time", "Tb", "posture","active","state","tau","dTc","Te","Abs"))), stringsAsFactors=F)
out<-0
bask<-0
